...
const nonSecurePaths = ["/logout", "/login", "/register", "/google", "/auth/google/callback", "/github", "/auth/github/callback", "/specialty/create"]; //mảng này chứa các phần sẽ sẽ không đượccheck quyền
